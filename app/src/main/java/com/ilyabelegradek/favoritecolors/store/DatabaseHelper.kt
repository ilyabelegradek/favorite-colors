...
import com.ilyabelegradek.favoritecolors.util.getContrastColor
import javax.inject.Inject

private const val TAG = "DatabaseHelper.kt"

class DatabaseHelper @Inject constructor(
    private val database: DatabaseReference
) {

    fun getColorsFromDB(onColorsLoaded: (List<ColorToFavorite>) -> Unit) {
    ...
    fun stopObservingUser(uid: String, listener: ValueEventListener) {
